#!/usr/bin/env python3
"""
Ramsey CLI - OQTOPUS Experiments Ramsey Oscillation Experiment
"""
...
class RamseyExperimentCLI(BaseExperimentCLI):
    """
    Ramsey experiment dedicated CLI (using OQTOPUS Experiments integrated framework)
    """

    def __init__(self):
        super().__init__(
            experiment_name="Ramsey",
            help_text="OQTOPUS Experiments Ramsey Oscillation Experiment",
        )
    ...
    def create_experiment_config_display(self, **kwargs) -> str:
        ...
        return (
            f"OQTOPUS Experiments Ramsey Oscillation Experiment\\n"
