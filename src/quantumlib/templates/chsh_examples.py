...
def angle_comparison_experiment():
    ...
    print(f"✅ Angle comparison completed")
...
def custom_phase_range_experiment():
    ...
    print(f"✅ Custom phase range experiment completed")
    ...
    if 'device_results' in results['analyzed_results']:
        for device, analysis in results['analyzed_results']['device_results'].items():
            ...
            for i, (phase, s) in enumerate(zip(custom_phases, s_values)):
...
def multi_device_chsh_experiment():
    ...
    print(f"✅ Multi-device experiment completed")
...
def advanced_chsh_with_custom_settings():
    ...
    print(f"🔧 Advanced OQTOPUS settings:")
    ...
    print(f"✅ Advanced CHSH experiment completed")
